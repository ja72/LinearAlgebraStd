...
namespace JA.Numerics.Simulation
{
    ...
    public static class OdeHelpers
    {
        ...
        /// <remarks>Linear interpolation is used to find phase vector between two solution points</remarks>
        ...
        /// <summary>Modifies solution by adding time step between consecutive points at the end of 
